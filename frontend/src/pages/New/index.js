...
export default function New({ history }){
    ...
    }, [thumbnail]) // quando a variável thumbnail for modificada, vai rodar o q tem dentro dos {}
    ...
    async function handleSubmit(event){
        ...
        //só q o JSON não aceita img então é usado o Multipart form no insomnia. por isso é da maneira a sguir:
